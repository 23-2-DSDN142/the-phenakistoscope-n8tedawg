...
function setup_layers(pScope){
  ...
  var layer1 = new PLayer(faces);// insert to faces the function you are using
  layer1.mode( SWIRL(5) ); // number determines how many of the object show on each slice. SWIRL goes out from the middle, towards the end
...
function faces(x, y, animation, pScope){ // emitting this affects the animation and makes it a swirl instead for some odd reason.
  ...
  scale(animation.frame*2);// emitting this affects the animation and makes it a swirl instead for some odd reason.
